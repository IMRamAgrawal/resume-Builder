...
const VerifyOTP = () => {
  ...
  const [
    resendOTP,
    { data: resendData, isSuccess: resendSuccess, isError: resendError },
  ] = useResendOtpMutation();
  const [sendOTP, { isSuccess, isError, error }] =
    useVerifyPhoneNumberMutation();
  const [deleteIncompleteSignup, { isSuccess: deleteSuccess }] =
    useDeleteIncompleteSignupMutation();
    ...
    <>
      <div className="w-screen h-[calc(98vh-80px)] flex flex-col justify-center items-center overflow-clip box-border">
        ...
        <div className=" flex flex-col justify-center items-center md:h-[500px] md:w-[800px] object-contain overflow-x-clip overflow-y-scroll md:overflow-y-clip bg-gradient-to-t from-white to-[#dae3e6] rounded-xl shadow shadow-gray-500 box-border pt-20 md:pt-0">
          <div className="mb-4 font-bold text-center px-4 md:px-0 py-4 rounded-xl tracking-wider text-xl">
            <p>Your QR resume is waiting for you Mate!!!</p>
          </div>
          <div className="flex flex-col-reverse md:flex-row justify-center items-center">
            ...
            <div className="p-4 flex flex-col justify-around rounded-2xl w-[70%] md:w-1/2">
              <form className="">
                <div className="flex flex-col py-2 text-center">
                  <p className="text-sm mb-5">
                    OTP has been sent to this {state?.phoneNumber}{" "}
                    <Link
                      to="/registeration/phoneNumber"
                      className="font-bold ml-8 text-[#003d4d] float-right mr-10 block mt-2 hover:text-red-700"
                      onClick={handleIncompleteSignUp}
                    >
                      Edit
                    </Link>
                  </p>
                ...
                <div className="flex justify-center">
                  <Link to="/setPassword">
                    <button
                      ...
                      className="border  my-2 py-2 px-5 rounded-2xl bg-[#57a7b3] hover:bg-[#57a7b3cc] text-white cursor-pointer"
                    >
                      VERIFY OTP
                    </button>
                  </Link>
              ...
              <span
                className="self-end mt-4 text-[#003d4d] hover:text-red-700 cursor-pointer"
