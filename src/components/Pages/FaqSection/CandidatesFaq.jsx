    ...
    <div className="w-9/12 flex-row border-2 rounded-2xl p-10 bg-white h-full">
      ...
      <ul className="flex flex-col">
        <li className="bg-white my-2 shadow-lg">
          ...
          >
            ...
            The Referral Program for candidates is a program where existing candidates can refer other candidates to ZealYug. As a reward for successful referrals, you can enjoy free advanced placement, highlighted profile and many more.
            </p>
          </div>
        </li>
      ...
      <ul className="flex flex-col">
        <li className="bg-white my-2 shadow-lg">
          ...
          >
            <p className="p-3 text-gray-900">
            No, there are no limitations on the number of referrals you can make. You are encouraged to refer as many candidates as you wish to maximize your chances of earning the referral rewards.
            </p>
          </div>
        </li>
        {/* Add the remaining FAQ items here */}
      ...
      <ul className="flex flex-col">
        <li className="bg-white my-2 shadow-lg">
          ...
          >
            <p className="p-3 text-gray-900">
            Once your referred, the other candidates engages in building profile on ZealYug and becomes an active user, your referral code will be validated and reward points will be added, which means your referral is successful.
